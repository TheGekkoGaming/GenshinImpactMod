...
public class CedarWoodFenceGateBlock extends GenshinImpactModModElements.ModElement {
	@ObjectHolder("genshin_impact_mod:cedar_wood_fence_gate")
	public static final Block block = null;
	public CedarWoodFenceGateBlock(GenshinImpactModModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("cedar_wood_fence_gate");
		}
