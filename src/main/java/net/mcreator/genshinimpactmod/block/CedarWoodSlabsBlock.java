...
public class CedarWoodSlabsBlock extends GenshinImpactModModElements.ModElement {
	@ObjectHolder("genshin_impact_mod:cedar_wood_slabs")
	public static final Block block = null;
	public CedarWoodSlabsBlock(GenshinImpactModModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("cedar_wood_slabs");
		}
